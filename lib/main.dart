            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Height (cm)',
                  labelStyle: TextStyle(fontSize: 20.0, color: Color.fromARGB(255, 227, 229, 231)),
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Color.fromARGB(255, 51, 222, 231)), 
                  ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle: TextStyle(fontSize: 20.0, color: Color.fromARGB(255, 227, 229, 231)),
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Color.fromARGB(255, 62, 212, 232)),
                  ),
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(fontSize: 30.0, color: Color.fromARGB(255, 248, 246, 246)),
              ...
              Text(
                'Category:'  
                '$result',
                style: TextStyle(fontSize: 25.0, color: Color.fromARGB(255, 249, 249, 250)),
                overflow: TextOverflow.ellipsis,
                maxLines:2,
              ),
              SizedBox(height: 20.0),
